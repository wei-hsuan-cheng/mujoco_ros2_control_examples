...
```bash
cd ~/ros2_ws/src
git clone https://github.com/wei-hsuan-cheng/mujoco_ros2_control_examples.git -b humble_arm64
cd ~/ros2_ws
...
```bash
# Marker control
ros2 launch interactive_marker interactive_marker.launch.py task:=open_door # open_door; push_load; peg_in_hole
